...
/*
	...
	lr_start_transaction("login-{userid}");
	...
	web_custom_request("remoteSqlService_142", 
		...
		"Mode=HTML", 
		"EncType=text/xml", 
		"BodyBinary=c\\x00\\x01m\\x00\\x07executeVt\\x00\\x7FSystem.Collections.Generic.List`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]l\\x00\\x00\\x00\\x01S\\x00\\xDA insert into FAP_OPERATIONLOG(ID,YEAR,NO_ID,SET_CODE,LOG_CONTENTS,LOG_TYPE,MAKE_USER,MAKE_DATE,LOG_IP) values(642423,2018,'','000010000200001','\\xE7\\x99\\xBB\\xE5\\xBD\\x95\\xE7\\xB3\\xBB\\xE7\\xBB\\x9F',1,'{userid}',CONVERT(varchar(100), GETDATE(), 25),'192.168.137.1')zz", 
		LAST);
	...
	lr_end_transaction("login-{userid}",LR_AUTO);
*/
	return 0;
}